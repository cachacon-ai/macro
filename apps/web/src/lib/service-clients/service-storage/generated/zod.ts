        ...
        .union([
          ...
          zod
            .object({
              data: zod
                ...
                .describe('A channel as displayed in Soup.'),
          ...
          zod
            .object({
              data: zod
                .object({
                  ...
                  edited_at: zod.iso
                    .datetime({})
                    .nullish()
                    .describe('Edit timestamp.'),
                  id: zod.uuid().describe('Message id.'),
                  reactions: zod
                    .array(
                      zod
                        .object({
                          emoji: zod.string().describe('Emoji string.'),
                          users: zod
                            .array(zod.string())
                            .describe('User ids who added this reaction.'),
                        })
              ...
              tag: zod.enum(['channelThread']),
            })
            .describe('Channel thread item.'),
          zod
            .object({
              data: zod
                .object({
    ...
    zod
      ...
      .and(
        zod
          ...
          .describe('Parameters for the initial grouped soup query.')
      )
      .describe('Request body for the initial grouped soup query.')
      .and(
        zod.object({
    ...
    zod
      ...
      .and(
        zod
          ...
          .describe('Parameters for fetching one page within a specific group.')
      )
      .describe('Request body for fetching one page within a specific group.')
      .and(
        zod.object({
...
export const postItemsSoupAstGroupedResponse = zod
  .union([
    ...
    zod
      ...
      .describe('Response for fetching a page within one group.')
      .and(
        zod.object({
          mode: zod.enum(['group_page']),
        })
