...
export class Sdk extends HeyApiClient {
     ...
     * @deprecated
     */
    public getRecentActivityHandler<ThrowOnError extends boolean = false>(options: Options<GetRecentActivityHandlerData, ThrowOnError>): RequestResult<GetRecentActivityHandlerResponses, GetRecentActivityHandlerErrors, ThrowOnError> {
        return (options.client ?? this.client).get<GetRecentActivityHandlerResponses, GetRecentActivityHandlerErrors, ThrowOnError>({ url: '/activity', ...options });
    }
     ...
     */
    public installSync<ThrowOnError extends boolean = false>(options?: Options<InstallSyncData, ThrowOnError>): RequestResult<unknown, unknown, ThrowOnError> {
        return (options?.client ?? this.client).get<unknown, unknown, ThrowOnError>({ url: '/github/install-sync', ...options });
    }
