...
/// jsonrpsee client or server, a [`Channel`] depends on nothing but
...
/// mid-flight (for example, partway through a jsonrpsee subscribe handshake)
/// is always polled to completion instead of being raced against, and
/// possibly cancelled by, an outgoing send becoming ready.
///
